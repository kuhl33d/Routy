...
export const routeValidation = [
  ...
  body("startLocation").isMongoId().withMessage("Invalid start location ID"),
  body("endLocation").isMongoId().withMessage("Invalid end location ID"),
  body("stops").isArray().withMessage("Stops must be an array"),
  body("stops.*.address").isMongoId().withMessage("Invalid stop address ID"),
];
...
export const schoolValidation = [
  ...
  body("address").isMongoId().withMessage("Invalid address ID"),
  body("phoneNumber")
    .isArray()
    .withMessage("Phone numbers must be an array")
    .notEmpty()
  ...
  body("email").isArray().withMessage("Emails must be an array"),
  ...
  body("adminEmails.*").isEmail().withMessage("Invalid admin email format"),
];
...
export const parentValidation = {
  create: [
    ...
    body("addresses.*").isMongoId().withMessage("Invalid address ID"),
    body("children")
      .optional()
      .isArray()
      .withMessage("Children must be an array"),
    body("children.*").optional().isMongoId().withMessage("Invalid student ID"),
  ],
  ...
  update: [
    ...
    body("children")
      ...
      .isArray()
      .withMessage("Children must be an array"),
    body("children.*").isMongoId().withMessage("Invalid student ID"),
  ],

  addChild: [body("studentId").isMongoId().withMessage("Invalid student ID")],
