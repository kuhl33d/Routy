...
const BusesPage: React.FC<BusesPageProps> = ({ buses }) => {
  console.log("BusesPage", buses);
...
const DriversPage: React.FC<DriversPageProps> = ({ drivers }) => {
  console.log("DriverPage", drivers);
...
const StudentsPage: React.FC<StudentsPageProps> = ({ students }) => {
  console.log("StudentsPage", students);
